...
def scrape_listing(url: str, section_slug: str) -> list[dict]:
    ...
    # Find the public.subcategory Livewire component snapshot
    snapshot = None
    ...
    for page_num in range(2, _MAX_PAGES + 1):
        ...
        if not new_items:
            break  # no new items = past last page
